    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          child: const MyHomePage(title: 'CUA Survey'),
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            if (_favoriteActivity == null || _activityImprovement == null ||
                _moreClubs == null || (_moreClubs == true && _newClubs == null) ||
                _attendEvents == null || (_attendEvents == true && _eventsPreference == null) ||
                _additionalQuestion == null || (_additionalQuestion == true && _soccerRating == null)) {
              setState(() {
                _formInvalid = true;
              });
            } else {
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              if (_feelSafe == null || _goodPlace == null || _safetyRating == null) {
                setState(() {
                  _formInvalid = true;
                });
              } else {
