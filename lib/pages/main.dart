            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: RichText(
                    text: TextSpan(
                      text: 'How would you describe the dining hall customer service?',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color: Colors.black,
                      ),
...
class _SportsSurveyState extends State<SportsSurvey> {
  ...
  void sendSportsSurveyResponses() async {
    // Create a map to hold the safety survey responses
    final Map<String, dynamic> responses = {
    ...
    // Send the responses to the server using HTTP POST
    final url = Uri.parse('https://surveyapp-f64f6-default-rtdb.firebaseio.com/sports-survey-responses.json');
    final response = await http.post(url, body: jsonBody);
